...
13 months, iterating over every available week. For each week it scrapes the table
...
`00.netflix_top10_english_shows_fullhistory.csv` is added manually and contains the
complete history of Netflix Top 10 English shows. It can be used to check whether a
previous season of a show made it to the Top 10. It is not generated by script, as
historical data no longer changes.
